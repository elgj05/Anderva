...
// ** Store & Actions
import { getData, deleteUser, getUser } from "@store/actions/users"
...
const DataTableServerSide = () => {
  ...
  const onDelete = (row) => {
    dispatch(deleteUser(row.id, refresh))
  }

  const onEdit = (row) => {
    dispatch(getUser(row.id, toggleEditSidebar))
  }
    ...
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Users Data</CardTitle>
