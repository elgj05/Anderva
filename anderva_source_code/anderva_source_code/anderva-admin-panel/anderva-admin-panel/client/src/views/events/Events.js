...
// ** Store & Actions
import { getData, deleteOne, getOne } from "@store/actions/events"
...
const serverSideColumns = (onDelete, onEdit) => {
  return [
    ...
    },
    {
      ...
      sortable: true,
      minWidth: "150px",
      cell: (row) => (row.createdByUser && row.createdByUser.email ? row.createdByUser.email : '-')
    },
    {
      name: "Created",
      selector: "createdAt",
    ...
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Events Data</CardTitle>
